  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
    ...
    <div>
      ...
      <div class="flex items-center border border-gray-300 rounded-lg overflow-hidden focus-within:ring-2 focus-within:ring-blue-500">
        ...
        <input type="text" name="slug" value="{{ old('slug') }}"
          class="flex-1 px-3 py-2.5 text-sm outline-none" placeholder="about-us">
      </div>
    ...
    <div class="flex items-center gap-6 pt-2">
      <label class="flex items-center gap-2 cursor-pointer">
        <input type="checkbox" name="is_published" value="1" checked class="rounded border-gray-300">
        <span class="text-sm text-gray-700">Published</span>
      </label>
      <label class="flex items-center gap-2 cursor-pointer">
        <input type="checkbox" name="show_in_popup" value="1" class="rounded border-gray-300">

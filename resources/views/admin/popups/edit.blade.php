    ...
    <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        ...
        <form action="{{ route('admin.popups.update', $popup->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ $popup->title }}" required class="w-full border border-gray-300 rounded-xl focus:ring-[#1a5632] focus:border-[#1a5632] p-3">
            </div>
            ...
            <div>
                ...
                <input type="url" name="link_url" value="{{ $popup->link_url }}" class="w-full border border-gray-300 rounded-xl focus:ring-[#1a5632] focus:border-[#1a5632] p-3">
            </div>

...
<div class="min-h-[70vh] flex items-center justify-center py-8">
  <div class="w-full max-w-md">
    <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
      <h1 class="text-2xl font-bold text-center text-slate-800 mb-2">नयाँ खाता बनाउनुहोस्</h1>
      <p class="text-sm text-center text-slate-500 mb-6">परिवार सदस्य अनुरोध पठाउन खाता आवश्यक छ</p>
      ...
      <form method="POST" action="{{ route('register') }}" class="space-y-4">
        @csrf
        <div>
          <label class="block text-sm font-medium text-slate-700 mb-1">पूरा नाम</label>
      ...
      <p class="mt-6 text-center text-sm text-slate-600">
        खाता छ?
        <a href="{{ route('login', ['next' => $returnTo]) }}" class="text-blue-600 font-medium hover:underline">लगइन गर्नुहोस्</a>
      </p>
    </div>
  </div>
</div>

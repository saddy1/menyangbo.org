...
<div class="min-h-[70vh] flex items-center justify-center py-8">
  <div class="w-full max-w-md">
    <div class="bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
      <h1 class="text-2xl font-bold text-center text-slate-800 mb-2">लगइन गर्नुहोस्</h1>
      <p class="text-sm text-center text-slate-500 mb-6">अनुरोध पठाउन लगइन आवश्यक छ</p>
      ...
      <form method="POST" action="{{ route('login') }}" class="space-y-4">
        ...
        <div>
          <label class="block text-sm font-medium text-slate-700 mb-1">पासवर्ड</label>
        ...
        <div class="flex items-center justify-between text-sm">
          <label class="flex items-center gap-2 cursor-pointer">
            ...
            <span class="text-slate-600">सम्झनुहोस्</span>
          </label>
          <a href="{{ route('password.request') }}" class="text-blue-600 hover:underline">पासवर्ड बिर्सनु भयो?</a>
        </div>
        <button type="submit"
      ...
      <div class="my-5 flex items-center gap-3">
        ...
        <span class="text-xs text-slate-400">अथवा</span>
        <div class="flex-1 h-px bg-slate-200"></div>
      </div>

      <a href="{{ route('auth.google', ['next' => $returnTo]) }}"
      ...
      <p class="mt-6 text-center text-sm text-slate-600">
        खाता छैन?
        <a href="{{ route('register') }}" class="text-blue-600 font-medium hover:underline">दर्ता गर्नुहोस्</a>
      </p>
    </div>
  </div>
</div>
